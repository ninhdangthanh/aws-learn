...
const file_grpc_user_user_proto_rawDesc = "" +
	"\n" +
	"\x14grpc/user/user.proto\x12\x04user\" \n" +
...
var (
	...
	file_grpc_user_user_proto_rawDescData []byte
)

func file_grpc_user_user_proto_rawDescGZIP() []byte {
	file_grpc_user_user_proto_rawDescOnce.Do(func() {
		file_grpc_user_user_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_grpc_user_user_proto_rawDesc), len(file_grpc_user_user_proto_rawDesc)))
	})
...
func file_grpc_user_user_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_grpc_user_user_proto_rawDesc), len(file_grpc_user_user_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
